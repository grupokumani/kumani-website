...
function renderWorkBlock(item) {
  ...
  return `
    <a href="/projetos/${item.slug}.html" class="work-block ${sizeClass}" data-reveal aria-label="Ver case study: ${item.cliente}">
...
function renderProductCard(item) {
  ...
  return `
    <article class="product-card" data-reveal>
      <a href="/produto/${item.slug}.html" aria-label="Ver produto: ${item.nome}">
